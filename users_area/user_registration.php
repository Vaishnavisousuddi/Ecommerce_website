...
<body>
    <div class="container-fluid">
        <h2 class="text-center mt-4 pt-2">New User Registration</h2>
        <div class="row d-flex lign-items-center justify-content-center" >
            <div class="col-lg-12 col-xl-6">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mt-4 pt-2">
                        <input type="submit" value="Register" class="bg-success py-2 px-3" name="user_register">
                    <p  class="fw-bold mt-2 pt-1 mb-3"> Already have an account? <a href="user_login.php" class="text-danger"> Login</a></p>
                    </div>
