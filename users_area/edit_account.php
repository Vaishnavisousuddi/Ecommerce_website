...
<img src="./user_images/<?php echo $user_image?>" alt="" class="edit_image" value= "<?php echo $user_image?> " >
    </div>
        <div class="form-outline mb-4">
    ...
    <input type="submit" value="Update" class="bg-info py-3 px-3"name="user_update">
