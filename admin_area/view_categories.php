...
?>
        <tr class="text-center">
            ...
            <td><a href='index.php?delete_category=<?php echo $category_id;?>' class='text-light' type="button" class="text-light" data-toggle="modal" data-target="#exampleModal"><i class='fa-solid fa-trash'><i></a></td>
