...
<div class="container mt-5">
    ...
    <div class="form-outline w-50 m-auto mb-4 p-2">
...
<div class="form-outline w-50 m-auto mb-4 p-2">
        <label for="product_image1" class="form-label m-auto">Product Image1</label>
        <div class="d-flex">
        <input type="file" id="product_image1" name="product_image1" class="form-control w-90 m-auto" required="required">
<img src="./product_images/ <?php echo $product_image1?>" alt="" class="product_img">
        </div>
    </div>
    <div class="form-outline w-50 m-auto p-2">
        <label for="product_image2" class="form-label m-auto">Product Image2</label>
        <div class="d-flex">
...
<img src="./product_images/ <?php echo $product_image2?>" alt="" class="product_img">
    ...
    <div class="form-outline w-50 m-auto p-2">
        <label for="product_image3" class="form-label m-auto">Product Image3</label>
        <div class="d-flex">
